...
export default function Footer() {
  return (
    <footer className="bg-[#022C22] text-green-50 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-green-200/80 mb-6 max-w-sm">
              L&apos;agriculture intelligente pour un avenir meilleur. Outil
              d&apos;aide à la décision conçu pour maximiser vos rendements.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Facebook"
              >
                <SocialIcon path="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.124 11.854v-8.385H7.456v-3.47h3.668v-2.642c0-3.62 2.154-5.62 5.452-5.62 1.58 0 3.232.282 3.232.282v3.556h-1.82c-1.795 0-2.354 1.114-2.354 2.255v2.173h4.004l-.64 3.47h-3.364v8.385C19.612 23.027 24 18.062 24 12.073z" />
              </a>
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-primary transition-colors"
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-green-200/60">
            &copy; 2026 Nyvoliko. Tous droits réservés.
          </p>
          <div className="flex items-center gap-4">
            <div className="bg-black/50 border border-white/10 px-4 py-2 rounded-lg flex items-center gap-2 cursor-pointer hover:bg-black transition-colors">
